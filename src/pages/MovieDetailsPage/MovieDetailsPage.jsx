...
export default function MovieDetails() {
  ...
  return (
    <>
      <NavLink to={backLink.current} className={css.goBackStyles}>
        Go Back
      </NavLink>
      ...
      <div>
        ...
        <ul>
          <li>
            <NavLink className={getLinkStyle} to={`/movies/${movieId}/cast`}>
              Cast
            </NavLink>
          </li>
          <li>
            <NavLink className={getLinkStyle} to={`/movies/${movieId}/reviews`}>
              Reviews
            </NavLink>
          </li>
        </ul>
